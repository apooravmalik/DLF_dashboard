        ...
        const response = await axios.post(`${config.API_BASE_URL}/api/dashboard/charts`, {
          charts: [
            ...
            },
            {
              ...
              drill_down_query: null,
              report_query: "SELECT ptsDeviceName_TXT AS 'Device Name', CASE WHEN ptsCurrentState_LNG = 1 THEN 'Online' WHEN ptsCurrentState_LNG = 2 THEN 'Offline' END AS  'Status' FROM PingTest_TBL WHERE ptsCameraZone_FRK IS NULL"
            }
          ]
        });
