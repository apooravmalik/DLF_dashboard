...
const ROI_OverviewPage = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#33414C] text-white">
      <h1 className="text-2xl font-bold text-center ">ROI Dashboard</h1>
...
export default ROI_OverviewPage;