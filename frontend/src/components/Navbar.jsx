...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed top-0 right-0 w-64 h-full bg-[#18181B] text-white transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out z-50`}>
        <button
          onClick={toggleMenu}
